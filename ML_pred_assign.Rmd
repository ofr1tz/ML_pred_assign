...
Predictions based on the model built with generalized boosted regression are still fairly accurate at more than 95%.

### Costs
Both algorithms are rather machine time consuming. Random forest, however, uses more than 150% more system time than generalized boosted regression.
